---
layout: post
title: Ignore them both
permalink: /ignore
---

Comments bring with it a fraught relationship state. The good one lifts you up and the not so good ones gnaw.
...
Shifted since to comments off as default.<nav style="display: flex; flex-direction: column; gap: 5px; margin-top: 10px; padding-top: 20px; border-top: 1px solid #eee;">
  ...
  <div>
    <a href="https://notes.sijokuruvilla.in/productivity" style="text-decoration: none; color: #0366d6;">← Previous: Make decisions about productivity</a>
  </div>
  <div>
